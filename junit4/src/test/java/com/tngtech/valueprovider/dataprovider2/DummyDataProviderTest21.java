...
public class DummyDataProviderTest21 {
    private static final Logger logger = LoggerFactory.getLogger(DummyDataProviderTest21.class);

    static {
        logger.debug("{}: static initialization", DummyDataProviderTest21.class.getSimpleName());
    }
