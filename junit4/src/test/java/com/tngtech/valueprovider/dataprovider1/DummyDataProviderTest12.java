...
public class DummyDataProviderTest12 {
    private static final Logger logger = LoggerFactory.getLogger(DummyDataProviderTest12.class);

    static {
        logger.debug("{}: static initialization", DummyDataProviderTest12.class.getSimpleName());
    }
