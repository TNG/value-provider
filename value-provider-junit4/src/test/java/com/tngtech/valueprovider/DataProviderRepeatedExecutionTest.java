...
public class DataProviderRepeatedExecutionTest {
    private static final Logger logger = LoggerFactory.getLogger(DataProviderRepeatedExecutionTest.class);

    static {
        logger.debug("{}: static initialization", DataProviderRepeatedExecutionTest.class.getSimpleName());
